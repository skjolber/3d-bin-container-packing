...
public class LargestAreaFitFirstPlacementControlsBuilder extends AbstractPlacementControlsBuilder<Placement> {
	...
	public ComparatorPlacementControls build() {
		...
		return new ComparatorPlacementControls(boxItems, boxItemsEndIndex, boxItemsEndIndex, pointControls, pointCalculator, container, stack, order, placementComparator, boxItemComparator);
	}
