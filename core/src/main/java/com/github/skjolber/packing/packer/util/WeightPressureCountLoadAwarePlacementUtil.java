 ...
 */
public class WeightPressureCountLoadAwarePlacementUtil extends AbstractLoadWeightPlacementUtil {

	public WeightPressureCountLoadAwarePlacementUtil(Stack stack) {
		super(stack);
	}
