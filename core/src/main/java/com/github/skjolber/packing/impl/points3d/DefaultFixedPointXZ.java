...
public class DefaultFixedPointXZ extends Point implements FixedPointZ, FixedPointX {
	...
	public DefaultFixedPointXZ(int minX, int minY, int minZ, int maxX, int maxY, int maxZ, 
