...
manifestControlsBuilderFactory = containerItem.getBoxItemControlsBuilderFactory();
		pointControlsBuilderFactory = containerItem.getPointControlsBuilderFactory();
		initialPoints = containerItem.getInitialPoints();
	}
