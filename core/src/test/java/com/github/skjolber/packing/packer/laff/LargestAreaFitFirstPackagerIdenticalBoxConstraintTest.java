 ...
 * {@code maxLoadIdenticalBoxCount} (identical-only stacking) constraint.
 */
public class LargestAreaFitFirstPackagerIdenticalBoxConstraintTest extends AbstractPackagerConstraintTest {
	 ...
	 * would be depth=2 above the first — exceeds the limit.
	 *
	 * <pre>
	 *  z |
	 *  3 +----------+   A3 — 2nd identical above A1  → depth=2 > 1  ✗ rejected
	 ...
	 *      0  5   10  x
	 *
	 *  container-1 (10×10×2): [ A at x=5, B at x=0 ]  side by side
	 * </pre>
	 */
	@Test
