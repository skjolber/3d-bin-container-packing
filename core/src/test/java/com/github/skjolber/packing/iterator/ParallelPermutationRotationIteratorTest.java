...
public class ParallelPermutationRotationIteratorTest {
	...
	void testPermutationsMultipleWorkUnitsWithRepeatedItems() {
		...
		products.add(new StackableItem(Box.newBuilder().with3DOrientations(1, 1, 3).withName("0").withWeight(1).build(), 1));
		products.add(new StackableItem(Box.newBuilder().with3DOrientations(1, 1, 3).withName("1").withWeight(1).build(), 3));
		products.add(new StackableItem(Box.newBuilder().with3DOrientations(1, 1, 3).withName("2").withWeight(1).build(), 4));		
