...
public class DefaultStackableItemGroupPermutationRotationIteratorTest {
	...
	void testPermutations() {
		...
		DefaultStackableItemGroupPermutationRotationIterator rotator = DefaultStackableItemGroupPermutationRotationIterator.newBuilder()
	...
	void testNexPermutationMaxIndexGroup1() {
		...
		DefaultStackableItemGroupPermutationRotationIterator iterator = DefaultStackableItemGroupPermutationRotationIterator.newBuilder()
				.withLoadSize(container)
				.withStackableItemGroups(groups)
				.withMaxLoadWeight(products2.size())
				.build();
