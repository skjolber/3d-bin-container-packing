...
public class Default3DPlanePoint3D extends SimplePoint3D implements XZPlanePoint3D, YZPlanePoint3D, XYPlanePoint3D {
	...
	@Override
	public Default3DPlanePoint3D clone(int maxX, int maxY, int maxZ) {
